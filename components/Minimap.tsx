...
export const Minimap: React.FC<MinimapProps> = ({ elements, viewport, onPanTo, onZoomIn, onZoomOut, onFitToScreen, usageStats, t }) => {
    ...
    <div className="fixed bottom-4 right-4 z-20 flex flex-col items-end gap-2 pointer-events-none">
      ...
      >
        <div className="flex items-center justify-between p-1">
          ...
          <button onClick={onFitToScreen} className="p-1 rounded hover:bg-gray-200 text-gray-700" title={t('fitToScreen')}>
